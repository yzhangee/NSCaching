...
parser.add_argument('--model', type=str, default='ComplEx',  help='scoring function, support [TransE, TransD, TransH, DistMult, ComplEx]')
...
parser.add_argument('--N_1', type=int, default=50, help='cache_size')
parser.add_argument('--N_2', type=int, default=50, help='random subset size')
